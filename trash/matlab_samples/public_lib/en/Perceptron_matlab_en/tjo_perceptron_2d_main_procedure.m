function [yvec,wvec]=tjo_perceptron_2d_main_procedure(xvec0)
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Perceptron for 2D data by Takashi J. OZAKI %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% [yvec,wvec]=tjo_perceptron_2d_main_procedure([3;3])
...
% Thus we have two 3 x 15 matrices as the training signals.
% They are in xy coordinates with a fixed bias value (= 1).
...
x1_list=[(1*ones(2,15)+c*rand(2,15));ones(1,15)]; % x1 (Group 1)
x2_list=[(-1*ones(2,15)-c*rand(2,15));ones(1,15)]; % x2 (Group 2)
...
wvec=[0;0;1]; % Initial weight vector
