function [yvec,wvec,bias]=tjo_perceptron_2d_main_procedure(xvec)
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% 例えば、[yvec,wvec]=tjo_perceptron_2d_main_procedure([3;3])
% とコマンドラインで入力してみて下さい。
...
x1_list=[(1*ones(2,15)+c*rand(2,15))];
x2_list=[(-1*ones(2,15)-c*rand(2,15))];
...
figure;
x_fig=-15:0.1:15;
y_fig=-(wvec(2)/wvec(1))*x_fig-(bias/wvec(2));
