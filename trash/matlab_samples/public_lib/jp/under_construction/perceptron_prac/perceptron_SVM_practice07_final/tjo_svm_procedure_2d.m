function [new_m,alpha,bias,linear_val]=tjo_svm_procedure_2d(xvec,delta,Cmax,loop)
%%
% SMO実装済み
...
% XOR
x1_list=[[(-1*ones(1,50)-c*rand(1,50));(ones(1,50)+c*rand(1,50))] ...
    [(ones(1,50)+c*rand(1,50));(-1*ones(1,50)-c*rand(1,50))]];
x2_list=[[(ones(1,50)+c*rand(1,50));(ones(1,50)+c*rand(1,50))] ...
    [-1*ones(1,50)-c*rand(1,50);-1*ones(1,50)-c*rand(1,50)]];
...
% 
% x1_list=[...
%     [(0*u+c*rand(1,10));(1*u+c*rand(1,10))] [(1*u+c*rand(1,10));(0*u+c*rand(1,10))] ... % 第1象限
%     [(-0*u-c*rand(1,10));(0*u+c*rand(1,10))] [(-1*u-c*rand(1,10));(1*u+c*rand(1,10))] ... % 第2象限
%     [(-0*u-c*rand(1,10));(-1*u-c*rand(1,10))] [(-1*u-c*rand(1,10));(-0*u-c*rand(1,10))] ... % 第3象限
%     [(0*u+c*rand(1,10));(-0*u-c*rand(1,10))] [(1*u+c*rand(1,10));(-1*u-c*rand(1,10))]... % 第4象限
%     ];
% x2_list=[...
%     [(0*u+c*rand(1,10));(0*u+c*rand(1,10))] [(1*u+c*rand(1,10));(1*u+c*rand(1,10))] ... % 第1象限
%     [(-1*u-c*rand(1,10));(0*u+c*rand(1,10))] [(-0*u-c*rand(1,10));(1*u+c*rand(1,10))] ... % 第2象限
%     [(-0*u-c*rand(1,10));(-0*u-c*rand(1,10))] [(-1*u-c*rand(1,10));(-1*u-c*rand(1,10))] ... % 第3象限
%     [(0*u+c*rand(1,10));(-1*u-c*rand(1,10))] [(1*u+c*rand(1,10));(-0*u-c*rand(1,10))]... % 第4象限
%     ];
...
[xx,yy]=meshgrid(-1.5:0.01:1.5,-1.5:0.01:1.5);
